...
public class ServiceLogAspect {
     ...
     * @param joinPoint
     */
    @Before("execution(* ${package}.service.impl.*.*(..))")
    public void logBefore(JoinPoint joinPoint){
        ...
        log.debug("=======request before===========${symbol_escape}n [{}]-[{}]-[{}].", clazzName,methodName,argsBuilder.toString());

    }

    @Around("execution(* ${package}.service.impl.*.*(..))")
     ...
     * @param reponse
     */
    @AfterReturning(value ="execution(* ${package}.service.impl.*.*(..))",returning = "reponse")
    public void logAfterRunning(JoinPoint joinPoint, Object reponse){
        ...
        log.info("=======response after===========${symbol_escape}n [{}]-[{}]-[{}]-[{}].", clazzName,methodName,reponse.toString(),argsBuilder.toString());
    }
}
